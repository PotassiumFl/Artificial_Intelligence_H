...
from ner import predict_transformer, train_transformer
...
if __name__ == "__main__":
    parsed = _parse_args()
    if parsed.cmd == "train":
        train_transformer(parsed.data_dir, parsed.model_out, parsed.lang)
    elif parsed.cmd == "predict":
        predict_transformer(parsed.input, parsed.output, parsed.model_in)
    else:
